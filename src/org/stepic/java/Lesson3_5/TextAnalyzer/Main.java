...
по набору анализаторов текста. checkLabels должен возвращать первую не-OK метку в порядке данного набора анализаторов,
...
public class Main {
    public static void main(String[] args) {
        ...
        String[] spamKeywords = {"spam", "bad", "fuck", "rude"};
        int commentMaxLength = 30;
